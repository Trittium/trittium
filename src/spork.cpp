...
int64_t GetSporkValue(int nSporkID)
{
    ...
    if (mapSporksActive.count(nSporkID)) {
        ...
        if (nSporkID == SPORK_18_FORCE_ENABLED_MASTERNODE) r = SPORK_18_FORCE_ENABLED_MASTERNODE_DEFAULT;
        if (nSporkID == SPORK_19_MASTERNODE_PRE_ENABLED_ENFORCEMENT) r = SPORK_19_MASTERNODE_PRE_ENABLED_ENFORCEMENT_DEFAULT;
...
int CSporkManager::GetSporkIDByName(std::string strName)
{
    ...
    if (strName == "SPORK_18_FORCE_ENABLED_MASTERNODE") return SPORK_18_FORCE_ENABLED_MASTERNODE;
    if (strName == "SPORK_19_MASTERNODE_PRE_ENABLED_ENFORCEMENT") return SPORK_19_MASTERNODE_PRE_ENABLED_ENFORCEMENT;
...
std::string CSporkManager::GetSporkNameByID(int id)
{
    ...
    if (id == SPORK_18_FORCE_ENABLED_MASTERNODE) return "SPORK_18_FORCE_ENABLED_MASTERNODE";
    if (id == SPORK_19_MASTERNODE_PRE_ENABLED_ENFORCEMENT) return "SPORK_19_MASTERNODE_PRE_ENABLED_ENFORCEMENT";
